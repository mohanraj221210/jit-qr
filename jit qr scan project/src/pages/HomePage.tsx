...
const HomePage: React.FC = () => {
  const schema = {
    ...
    "logo": `${window.location.origin}/noticelogo.png`,
      ...
      {/* <nav className="glass-navbar">
        <div className="nav-container">
          <Link to="/" className="nav-brand">
            <img src="/noticelogo.png" alt="JIT Logo" className="nav-logo" />
        ...
        <div className={`notice-board-frame ${mounted ? 'animate-in' : ''}`}>
          ...
          <div className="notice-board-surface">
            ...
            <div className="board-header-note">
              ...
              <img src="/noticelogo.png" alt="JIT Seal" className="header-seal" />
